...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            logger.info("Aplying LAbel Encoding")
    ...
    def balanced_data(self,df):
        try:
            ...
            logger.info("Data balanced sucesssfully")
            return balanced_df
        
        except Exception as e:
            logger.error(f"Error during balancing data step {e}")
            raise CustomException("Error while balanceing data", e)
    ...
    def process(self):
        try:
            logger.info("Loading dat from RAW directory")
